...
control MyIngress(inout headers hdr,
    ...
    apply {
        if (hdr.probe.isValid()) {
            ...
            bit<64> ft = (bit<64>)standard_metadata.ingress_global_timestamp;
            ...
            // update count
            // pre-emphasis 
            ft = ft >> 10; // microsecond to millisecond
            ft = ft * TIME_PARAM;
            ...
            // de-emphasis
            // min count /= ft
            // division issue: https://github.com/p4lang/p4c/issues/1232
            min_count = min_count / ft;
